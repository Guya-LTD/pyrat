...
{{cookiecutter.project_name}} is a Python based Microservice API
...
export FLASK_APP={{cookiecutter.repo_name}} (optional)
...
`waitress-serve --call '{{cookiecutter.repo_name}}:create_app'`
